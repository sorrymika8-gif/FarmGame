...
{
    internal class HMIAndroidPlatformSetup : IPlatformSetup
    {
        ...
        {
#if UNITY_2021_2_OR_NEWER
            m_oldApplicationIdentifier = PlayerSettings.GetApplicationIdentifier(NamedBuildTarget.HMIAndroid);
            PlayerSettings.SetApplicationIdentifier(NamedBuildTarget.HMIAndroid, "com.UnityTestRunner.UnityTestRunner");
#else
            m_oldApplicationIdentifier = PlayerSettings.GetApplicationIdentifier(BuildTargetGroup.HMIAndroid);
            PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.HMIAndroid, "com.UnityTestRunner.UnityTestRunner");
#endif
...
#if UNITY_2021_2_OR_NEWER
            PlayerSettings.SetApplicationIdentifier(NamedBuildTarget.HMIAndroid, m_oldApplicationIdentifier);
#else
            PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.HMIAndroid, m_oldApplicationIdentifier);
#endif
        }
    }
}
